...
실제 공시, 중대 위험 없음 조건을 모두 만족해야 합니다. 국내 현금흐름은 DART 전체
재무제표의 연간 영업현금흐름과 PPE 취득액이 같은 연결 기준에서 모두 확인될 때만
증분 체크포인트로 보강합니다.

DART와 SEC 자체에는 현재 주가가 없으므로 별도 시세의 기준일과 출처를 함께 표시합니다.
PER·PBR·PSR·FCF 수익률은 가치평가 참고값이며 기업별 가격 커버리지가 같아지기 전까지
점수에는 넣지 않습니다.
